<x-app-layout>
    ...
    }" x-data="{ selectedTransaction: {}, url: '{{ route('inbound.index') }}', selectedGoods: {} }">
            ...
            <div class="container-fluid">
                ...
                <form class="gap-2 d-flex justify-content-end" role="search">
                    ...
                    <input style="width: 140px;" value="{{ request('number') }}" name="number"
                        class="form-control md-2" type="search" placeholder="No Brng Masuk" aria-label="Search">
                    <button class="btn btn-outline-success" type="submit">Search</button>
                    <a class="btn btn-outline-success" href="{{ route('inbound.index') }}">Reset</a>
                </form>
            </div>
        </nav>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Tanggal Masuk : <span x-text="transaction.date"></span></p>
                            <p>Deskripsi : <span x-text="transaction.description"></span></p>
                            <div class="alert alert-warning" role="alert">
                                Peringatan! Barang masuk yang sudah disimpan tidak dapat diubah dan dihapus. Gunakan
                        ...
                        <div class="modal-body">
                            <div class="mb-3 input-group">
                                ...
                                <input x-model="transaction.number"
                                    ...
                                    placeholder="Nomor Barang Masuk" aria-label="Nomor Barang Masuk"
                                    aria-describedby="Nomor Barang Masuk">
